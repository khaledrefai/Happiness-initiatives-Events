...
import ae.gov.dubaipolice.happy.repository.AttachmentRepository;
...
/**
 * REST controller for managing {@link ae.gov.dubaipolice.happy.domain.Attachment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Attachment> partialUpdateAttachment(
        ...
        Optional<Attachment> result = attachmentRepository
            ...
            .map(existingAttachment -> {
                ...
                if (attachment.getAttachFileContentType() != null) {
                    existingAttachment.setAttachFileContentType(attachment.getAttachFileContentType());
                }
