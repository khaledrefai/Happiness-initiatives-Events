...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HAPPINITTYP_LIST actions', async () => {
    ...
    it('dispatches FETCH_HAPPINITTYP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HAPPINITTYP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HAPPINITTYP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HAPPINITTYP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HAPPINITTYP actions', async () => {
      const expectedActions = [
        {
