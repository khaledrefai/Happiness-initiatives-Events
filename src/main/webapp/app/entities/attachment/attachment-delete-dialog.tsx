...
export const AttachmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="happinessInitiativesApp.attachment.delete.question">
        <Translate contentKey="happinessInitiativesApp.attachment.delete.question" interpolate={{ id: attachmentEntity.id }}>
