...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HAPPEVNTTYP_LIST actions', async () => {
    ...
    it('dispatches FETCH_HAPPEVNTTYP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HAPPEVNTTYP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HAPPEVNTTYP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HAPPEVNTTYP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HAPPEVNTTYP actions', async () => {
      const expectedActions = [
        {
