...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HAPPEVNTPLAC_LIST actions', async () => {
    ...
    it('dispatches FETCH_HAPPEVNTPLAC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HAPPEVNTPLAC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HAPPEVNTPLAC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HAPPEVNTPLAC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HAPPEVNTPLAC actions', async () => {
      const expectedActions = [
        {
