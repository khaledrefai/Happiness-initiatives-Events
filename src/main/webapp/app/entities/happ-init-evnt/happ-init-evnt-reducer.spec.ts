...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HAPPINITEVNT_LIST actions', async () => {
    ...
    it('dispatches FETCH_HAPPINITEVNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HAPPINITEVNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HAPPINITEVNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HAPPINITEVNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HAPPINITEVNT actions', async () => {
      const expectedActions = [
        {
