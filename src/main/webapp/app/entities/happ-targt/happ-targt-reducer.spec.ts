...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HAPPTARGT_LIST actions', async () => {
    ...
    it('dispatches FETCH_HAPPTARGT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HAPPTARGT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HAPPTARGT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HAPPTARGT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HAPPTARGT actions', async () => {
      const expectedActions = [
        {
